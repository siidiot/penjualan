 <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <?php echo form_open('barang/post'.$record->barang_id,['class'=>'form-horizontal form-label-left'], 'novalidate')?>

                      <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Nama Barang <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="nama_barang" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="1"  name="nama_barang" value="<?=$record->nama_barang?>"  required="required" type="text">
                        </div>
                      </div>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-2 col-sm-6 col-xs-12">
                          <input id="prod_unit" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="1"  name="prod_unit" value="<?=$record->prod_unit?>" required="required" type="text">
                        </div>
                      </div>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-12">
                          <input type="number" id="harga" name="harga" value="<?=$record->harga?>" required="required" data-validate-minmax="10" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
